...
public class UserDatabaseSQLiteHandler extends SQLiteOpenHelper {

    private static final String TAG = UserDatabaseSQLiteHandler.class.getSimpleName();
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_LOGIN_TABLE = "CREATE TABLE " + TABLE_USER + "("
                ...
                + KEY_CREATED_AT + " TEXT," + KEY_PATIENT_ID + " TEXT" + ")";
