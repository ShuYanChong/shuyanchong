...
public class WriteNfcTagActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new AlertDialog.Builder(this)
                .setTitle(getResources().getString(R.string.delete_tag))
                .setMessage(getResources().getString(R.string.delete_tag))
...
//        }
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (intent.hasExtra(NfcAdapter.EXTRA_TAG)) {
            Toast.makeText(this, getResources().getString(R.string.tag_detected), Toast.LENGTH_SHORT).show();
...
//                    Toast.makeText(this, "NFC Tag has been successfully encoded.", Toast.LENGTH_LONG).show();
                    new AlertDialog.Builder(this)
                            .setTitle(getResources().getString(R.string.erasing_tag1))
                            .setMessage(getResources().getString(R.string.erasing_tag2))
                            .setNeutralButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    // continue with delete
                                }
                    ...
                    Toast.makeText(this, getResources().getString(R.string.unwritable_tag), Toast.LENGTH_SHORT).show();
                }
                ndefTag.close();
            } catch (Exception e) {
            ...
            new AlertDialog.Builder(this)
                    .setTitle(getResources().getString(R.string.cleared_tag1))
                    .setMessage(getResources().getString(R.string.cleared_tag2))
