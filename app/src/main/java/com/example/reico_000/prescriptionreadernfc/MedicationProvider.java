...
public class MedicationProvider extends ContentProvider {
    ...
    private static final int MEDICATION_USE_HISTORY_LIST = 12;
    private static final int MEDICATION_USE_HISTORY_ID = 13;
    ...
    static {
        ...
        URI_MATCHER.addURI(MedicationContract.AUTHORITY,
                ...
                MEDICATION_USE_HISTORY_LIST);
        URI_MATCHER.addURI(MedicationContract.AUTHORITY,
                "medicationUseHistoryTable/#",
                MEDICATION_USE_HISTORY_ID);
        URI_MATCHER.addURI(MedicationContract.AUTHORITY,
                "pastMedicationTable",
...
//                ENTITY_ID);
    ...
    public String getType(Uri uri) {
        switch (URI_MATCHER.match(uri)) {
            ...
            case MEDICATION_USE_HISTORY_ID:
                return MedicationContract.MedicationUseHistory.CONTENT_TYPE;
            case MEDICATION_USE_HISTORY_LIST:
                return MedicationContract.MedicationUseHistory.CONTENT_MEDICATION_USE_HISTORY_TYPE;
...
//                return ItemEntities.CONTENT_TYPE;
    ...
    public Cursor query(
        ...
        switch (URI_MATCHER.match(uri)) {
            ...
            case SYMPTOMS_ID:
                ...
                break;
            case MEDICATION_USE_HISTORY_LIST:
                builder.setTables(MedicationDatabaseSQLiteHandler.TABLE_MEDICATION_USE_HISTORY);
                break;
            case MEDICATION_USE_HISTORY_ID:
                builder.setTables(MedicationDatabaseSQLiteHandler.TABLE_MEDICATION_USE_HISTORY);
                break;
    ...
    public Uri insert(Uri uri, ContentValues values) {
        if (URI_MATCHER.match(uri) != MED_LIST
                ...
                && URI_MATCHER.match(uri) != MEDICATION_USE_HISTORY_LIST
                ) {
            throw new IllegalArgumentException(
        ...
        else if (URI_MATCHER.match(uri) == MEDICATION_USE_HISTORY_LIST){
            long id =
                    db.insert(
                            MedicationDatabaseSQLiteHandler.TABLE_MEDICATION_USE_HISTORY,
                            null,
                            values);
            return getUriForId(id, uri);
        }
...
//            }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (URI_MATCHER.match(uri)) {
            ...
            case MEDICATION_USE_HISTORY_ID:
                idStr = uri.getLastPathSegment();
                where = MedicationContract.MedicationUseHistory._ID + " = " + idStr;
                if (!TextUtils.isEmpty(selection)) {
                    where += " AND " + selection;
                }
                delCount = db.delete(
