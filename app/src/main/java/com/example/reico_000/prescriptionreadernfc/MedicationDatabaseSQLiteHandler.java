...
public class  MedicationDatabaseSQLiteHandler extends SQLiteOpenHelper{
    ...
    public static final String TABLE_MEDICATION_USE_HISTORY = "medicationUseHistoryTable";
    ...
    public static final String[] ALL_CONSUMPTION_KEYS = new String[] {KEY_ID, KEY_MEDICATION_ID,
            KEY_CONSUMED_AT, KEY_IS_TAKEN, KEY_REMAINING_DOSAGE};
    ...
    // Medication Use History table column names
    public static final String KEY_MEDICATION_USE_HISTORY = "MedicationUseHistory";
    public static final String KEY_MEDICATION_CONSUMED_AT = "MedicationConsumedOn";
    public static final String[] ALL_MEDICATION_USE_HISTORY_KEYS = new String[] {KEY_ID, KEY_MEDICATION_USE_HISTORY,
	...
	public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_MEDICATION_USE_HISTORY_TABLE = "CREATE TABLE " + TABLE_MEDICATION_USE_HISTORY + "(" + KEY_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                KEY_MEDICATION_USE_HISTORY + " TEXT," + KEY_MEDICATION_CONSUMED_AT + " TEXT )";
        ...
        db.execSQL(CREATE_MEDICATION_USE_HISTORY_TABLE);
	...
	public void onUpgrade(SQLiteDatabase db, int i, int i2) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_MEDICATION_USE_HISTORY);
        onCreate(db);
    }
...
//                medicationObject.set_ID(Integer.parseInt(cursor.getString(0)));
    ...
    public Cursor getAllRows() {
        ...
        if (c != null) {
            Log.d("Test Fragment Cursor", "it is not null");
            c.moveToFirst();
        } else {
